...
public class DiamondFurnaceScreen extends AbstractContainerScreen<DiamondFurnaceMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/diamond_furnace.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public DiamondFurnaceScreen(DiamondFurnaceMenu menu, Inventory inventory, Component title) {
