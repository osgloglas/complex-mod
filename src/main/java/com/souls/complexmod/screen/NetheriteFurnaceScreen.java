...
public class NetheriteFurnaceScreen extends AbstractContainerScreen<NetheriteFurnaceMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/netherite_furnace.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public NetheriteFurnaceScreen(NetheriteFurnaceMenu menu, Inventory inventory, Component title) {
