...
public class ParticleCollectorScreen extends AbstractContainerScreen<ParticleCollectorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/particle_collector.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public ParticleCollectorScreen(ParticleCollectorMenu menu, Inventory inventory, Component title) {
