...
public class AmethineCrystalFurnaceStackScreen extends AbstractContainerScreen<AmethineCrystalFurnaceStackMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/amethine_crystal_furnace_stack.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public AmethineCrystalFurnaceStackScreen(AmethineCrystalFurnaceStackMenu menu, Inventory inventory, Component title) {
