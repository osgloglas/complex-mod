...
public class IronFurnaceStackScreen extends AbstractContainerScreen<IronFurnaceStackMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/iron_furnace_stack.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public IronFurnaceStackScreen(IronFurnaceStackMenu menu, Inventory inventory, Component title) {
