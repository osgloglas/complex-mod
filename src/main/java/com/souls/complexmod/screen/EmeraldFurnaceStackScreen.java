...
public class EmeraldFurnaceStackScreen extends AbstractContainerScreen<EmeraldFurnaceStackMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/emerald_furnace_stack.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public EmeraldFurnaceStackScreen(EmeraldFurnaceStackMenu menu, Inventory inventory, Component title) {
