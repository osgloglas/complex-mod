...
public class EmeraldFurnaceScreen extends AbstractContainerScreen<EmeraldFurnaceMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/emerald_furnace.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public EmeraldFurnaceScreen(EmeraldFurnaceMenu menu, Inventory inventory, Component title) {
