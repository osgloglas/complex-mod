...
public class StarFactoryScreen extends AbstractContainerScreen<StarFactoryMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/star_factory.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public StarFactoryScreen(StarFactoryMenu menu, Inventory inventory, Component title) {
