...
public class NetheriteStencilTableScreen extends AbstractContainerScreen<NetheriteStencilTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ComplexMod.MOD_ID, "textures/gui/netherite_stencil_table.png");

    private final int imageWidth, imageHeight;
    private int leftPos, topPos;

    public NetheriteStencilTableScreen(NetheriteStencilTableMenu menu, Inventory inventory, Component title) {
