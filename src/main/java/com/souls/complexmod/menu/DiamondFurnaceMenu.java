...
public class DiamondFurnaceMenu extends AbstractContainerMenu {
    private final DiamondFurnaceBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    public DiamondFurnaceMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (DiamondFurnaceBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
            new SimpleContainerData(2));
    }

    public DiamondFurnaceMenu(int id, Inventory pInv, DiamondFurnaceBlockEntity bEntity, ContainerData extraData) {
        super(ModMenus.DIAMOND_FURNACE_MENU.get(), id);
    ...
    public DiamondFurnaceBlockEntity getBlockEntity() {
