...
public class NetheriteFurnaceMenu extends AbstractContainerMenu {
    private final NetheriteFurnaceBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    public NetheriteFurnaceMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (NetheriteFurnaceBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
            new SimpleContainerData(2));
    }

    public NetheriteFurnaceMenu(int id, Inventory pInv, NetheriteFurnaceBlockEntity bEntity, ContainerData extraData) {
        super(ModMenus.NETHERITE_FURNACE_MENU.get(), id);
    ...
    public NetheriteFurnaceBlockEntity getBlockEntity() {
