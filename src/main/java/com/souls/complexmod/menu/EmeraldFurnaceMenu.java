...
public class EmeraldFurnaceMenu extends AbstractContainerMenu {
    private final EmeraldFurnaceBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    public EmeraldFurnaceMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (EmeraldFurnaceBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
            new SimpleContainerData(2));
    }

    public EmeraldFurnaceMenu(int id, Inventory pInv, EmeraldFurnaceBlockEntity bEntity, ContainerData extraData) {
        super(ModMenus.EMERALD_FURNACE_MENU.get(), id);
    ...
    public EmeraldFurnaceBlockEntity getBlockEntity() {
