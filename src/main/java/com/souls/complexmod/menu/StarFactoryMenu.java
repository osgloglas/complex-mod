...
import com.souls.complexmod.block.entity.StarFactoryBlockEntity;
...
public class StarFactoryMenu extends AbstractContainerMenu {
    private final StarFactoryBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    public StarFactoryMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (StarFactoryBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
            new SimpleContainerData(2));
    }

    public StarFactoryMenu(int id, Inventory pInv, StarFactoryBlockEntity bEntity, ContainerData extraData) {
        super(ModMenus.STAR_FACTORY_MENU.get(), id);
    ...
    public StarFactoryBlockEntity getBlockEntity() {
