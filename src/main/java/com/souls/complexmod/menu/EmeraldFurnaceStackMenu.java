...
public class EmeraldFurnaceStackMenu extends AbstractContainerMenu {
    private final EmeraldFurnaceStackBlockEntity blockEntity;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    //client constructor
    public EmeraldFurnaceStackMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (EmeraldFurnaceStackBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
                new SimpleContainerData(2));
    }

    //server constructor
    public EmeraldFurnaceStackMenu(int containerId, Inventory pInv, EmeraldFurnaceStackBlockEntity blockEntity, ContainerData extraData) {
        super(ModMenus.EMERALD_FURNACE_STACK_MENU.get(), containerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.levelAccess, pPlayer, ModBlocks.EMERALD_FURNACE_STACK.get());
    }
    ...
    public EmeraldFurnaceStackBlockEntity getBlockEntity() {
