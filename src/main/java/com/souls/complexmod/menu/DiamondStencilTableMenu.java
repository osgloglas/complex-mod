...
public class DiamondStencilTableMenu extends AbstractContainerMenu {
    private final DiamondStencilTableBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;

    public DiamondStencilTableMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv,
            (DiamondStencilTableBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()));
    }

    public DiamondStencilTableMenu(int id, Inventory pInv, DiamondStencilTableBlockEntity bEntity) {
        super(ModMenus.DIAMOND_STENCIL_TABLE_MENU.get(), id);
