...
public class IronStencilTableMenu extends AbstractContainerMenu {
    private final IronStencilTableBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;

    public IronStencilTableMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv,
            (IronStencilTableBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()));
    }

    public IronStencilTableMenu(int id, Inventory pInv, IronStencilTableBlockEntity bEntity) {
        super(ModMenus.IRON_STENCIL_TABLE_MENU.get(), id);
