...
public class AmethineCrystalFurnaceMenu extends AbstractContainerMenu {
    private final AmethineCrystalFurnaceBlockEntity blockEntity;
    private final Level level;
    private final ItemStackHandler items;
    private final ContainerLevelAccess levelAccess;
    private final ContainerData data;

    public AmethineCrystalFurnaceMenu(int containerId, Inventory pInv, FriendlyByteBuf buf) {
        this(containerId, pInv, (AmethineCrystalFurnaceBlockEntity) pInv.player.level().getBlockEntity(buf.readBlockPos()),
            new SimpleContainerData(2));
    }

    public AmethineCrystalFurnaceMenu(int id, Inventory pInv, AmethineCrystalFurnaceBlockEntity bEntity, ContainerData extraData) {
        super(ModMenus.AMETHINE_CRYSTAL_FURNACE_MENU.get(), id);
    ...
    public AmethineCrystalFurnaceBlockEntity getBlockEntity() {
