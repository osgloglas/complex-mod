...
public class StencilShapedRecipe implements Recipe<SimpleContainer> {
    // Implementation details would go here
    private final ResourceLocation id;
    private final NonNullList<Ingredient> inputs;
    private final ItemStack output;

    public StencilShapedRecipe(ResourceLocation id, String group, int width, int height,
    ...
    public static class Type implements RecipeType<StencilShapedRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "complexmod:stencil_shaped";
    }

    public static class Serializer implements RecipeSerializer<StencilShapedRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ComplexMod.MOD_ID, "stencil_shaped");

        @Override
        public StencilShapedRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new StencilShapedRecipe(recipeId, "", 3, 3, inputs, output);
        }

        @Override
        public StencilShapedRecipe fromNetwork(ResourceLocation recipeId, net.minecraft.network.FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(net.minecraft.network.FriendlyByteBuf buffer, StencilShapedRecipe recipe) {
