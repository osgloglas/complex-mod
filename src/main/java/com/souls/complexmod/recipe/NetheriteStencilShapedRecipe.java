...
public class NetheriteStencilShapedRecipe implements Recipe<SimpleContainer> {
    // Implementation details would go here
    private final ResourceLocation id;
    private final NonNullList<Ingredient> inputs;
    private final ItemStack output;

    public NetheriteStencilShapedRecipe(ResourceLocation id, String group, int width, int height,
    ...
    public boolean matches(SimpleContainer container, Level level) {
        ...
        return inputs.get(0).test(container.getItem(0)) && inputs.get(1).test(container.getItem(1)) &&
               ...
               inputs.get(24).test(container.getItem(24));
    }
    ...
    public static class Type implements RecipeType<NetheriteStencilShapedRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "complexmod:netherite_stencil_shaped";
    }

    public static class Serializer implements RecipeSerializer<NetheriteStencilShapedRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ComplexMod.MOD_ID, "netherite_stencil_shaped");

        @Override
        public NetheriteStencilShapedRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            for (int row = 0; row < height; row++) {
                ...
                for (int col = 0; col < width; col++) {
                    ...
                    inputs.set(row * 5 + col, ingredient);
                }
            }
            
            ItemStack output = ShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(json, "result"));

            return new NetheriteStencilShapedRecipe(recipeId, "", 5, 5, inputs, output);
        }

        @Override
        public NetheriteStencilShapedRecipe fromNetwork(ResourceLocation recipeId, net.minecraft.network.FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(net.minecraft.network.FriendlyByteBuf buffer, NetheriteStencilShapedRecipe recipe) {
