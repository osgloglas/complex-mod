...
public class EmeraldStencilShapedRecipe implements Recipe<SimpleContainer> {
    // Implementation details would go here
    private final ResourceLocation id;
    private final NonNullList<Ingredient> inputs;
    private final ItemStack output;

    public EmeraldStencilShapedRecipe(ResourceLocation id, String group, int width, int height,
    ...
    public static class Type implements RecipeType<EmeraldStencilShapedRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "complexmod:emerald_stencil_shaped";
    }

    public static class Serializer implements RecipeSerializer<EmeraldStencilShapedRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ComplexMod.MOD_ID, "emerald_stencil_shaped");

        @Override
        public EmeraldStencilShapedRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new EmeraldStencilShapedRecipe(recipeId, "", 5, 5, inputs, output);
        }

        @Override
        public EmeraldStencilShapedRecipe fromNetwork(ResourceLocation recipeId, net.minecraft.network.FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(net.minecraft.network.FriendlyByteBuf buffer, EmeraldStencilShapedRecipe recipe) {
